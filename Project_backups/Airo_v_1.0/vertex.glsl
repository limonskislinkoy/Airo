...
void main()
{
    ...
    vec3 newpos= vec3(vec4(position+sin(gc_time/1.0f)*normal/100.f,1.0f));

    gl_Position = projection*(transmat_rotate_pitch*transmat_rotate_yaw*transmat_rotate_roll*vec4(newpos-transmat_offset,1.0));
